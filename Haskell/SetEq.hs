module SetEq (Set(..),emptySet,isEmpty,inSet,subSet,insertSet,
              deleteSet,powerSet,takeSet,list2set,(!!!), unionSet1)  
...
unionSet1 :: Eq a => Set a -> Set a -> Set a
unionSet1 (Set []) set2 = set2
unionSet1 (Set (x:xs)) set2 = insertSet x (unionSet1 (Set xs) set2)
